...
/*
 * FrmTop10Ranking.java
 *
 * Created on 12-12-2011, 07:18:36 PM
 */
package uno;
 ...
 * @author DAVID
 */
public class FrmTop10Ranking extends javax.swing.JFrame {

    /** Creates new form FrmTop10Ranking */
    public FrmTop10Ranking() {
        initComponents();
   ...
   private void Cargar()
{
   ...
   ArrayList<String> jugs =ControlUsuarios.GetRankingTop10();
   int x=10,y=10;
   int c=1;
   for (String p :jugs)
   {
...
//       JLabel label =new JLabel(Imagenes.Top10Detalle());
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(uno.UnoApp.class).getContext().getResourceMap(FrmTop10Ranking.class);
        ...
        jPanel1.setBounds(0, 120, 700, 530);
...
jLabel3.setIcon(Imagenes.MenuSalir());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmTop10Ranking.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new FrmTop10Ranking().setVisible(true);
            }
        });
    }
